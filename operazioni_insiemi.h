...
extern el_insieme_t *calcola_intersezione(el_insieme_t *el_primo_insieme,    /* Elemento testa
                                                                              * del primo insieme */
                                          el_insieme_t *el_secondo_insieme); /* Elemento testa
                                                                              * del secondo insieme */
...
extern el_insieme_t *calcola_differenza(el_insieme_t *el_primo_insieme,    /* Elemento testa
                                                                            * del primo insieme */
                                        el_insieme_t *el_secondo_insieme); /* Elemento testa
                                                                            * del secondo insieme */
